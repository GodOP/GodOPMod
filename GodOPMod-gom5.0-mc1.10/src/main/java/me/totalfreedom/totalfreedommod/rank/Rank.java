...
public enum Rank implements Displayable
{
    ...
    SUPER_ADMIN("a", "Super Admin", Type.ADMIN, "Super Admin", ChatColor.GOLD),
    TELNET_ADMIN("a", "Telnet Admin", Type.ADMIN, "Telnet Admin", ChatColor.AQUA),
    SENIOR_ADMIN("a", "Senior Admin", Type.ADMIN, "Senior Admin", ChatColor.LIGHT_PURPLE),
    TELNET_CONSOLE("the", "Console", Type.ADMIN_CONSOLE, "Console", ChatColor.GREEN),
    SENIOR_CONSOLE("the", "Console", Type.ADMIN_CONSOLE, "Console", ChatColor.GREEN);
    @Getter
