...
@CommandParameters(description = "Manage admins in game.", usage = "/<command> <list | clean | reload | | setrank <username> <rank> | <add | remove | info> <username>>", aliases = "admin")
public class Command_setadmin extends FreedomCommand
{
